...
class HospedeDAO{
	...
	public function update(Hospede $hospede){
		try {
			$sql = "UPDATE hospede SET nome=:nome, telefone=:telefone, sexo=:sexo, datanascimento = :dataNascimento WHERE cpfhospede = :cpfhospede";
			...
			print "<br>Erro ao atualizar hospede " . $e;	
